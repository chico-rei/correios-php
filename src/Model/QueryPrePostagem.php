...
class QueryPrePostagem extends PrePostagem
{
    ...
    public function setId(?string $id): QueryPrePostagem
    {
        $this->id = $id;
        return $this;
    }
    ...
    public function setEticket(?string $eticket): QueryPrePostagem
    {
    ...
    public function setEmbalagem(?string $embalagem): QueryPrePostagem
    {
    ...
    public function setServico(?string $servico): QueryPrePostagem
    {
    ...
    public function setStatusAtual(?int $statusAtual): QueryPrePostagem
    {
    ...
    public function setDescStatusAtual(?string $descStatusAtual): QueryPrePostagem
    {
    ...
    public function setTipoRotulo(?string $tipoRotulo): QueryPrePostagem
    {
    ...
    public function setRetornoIntegracao(?string $retornoIntegracao): QueryPrePostagem
    {
    ...
    public function setSistemaOrigem(?string $sistemaOrigem): QueryPrePostagem
    {
    ...
    public function setValorTotalBens(?float $valorTotalBens): QueryPrePostagem
    {
    ...
    public function setListaIdPrepostagemObjetos(?array $listaIdPrepostagemObjetos): QueryPrePostagem
    {
    ...
    public function setQuantidade(?int $quantidade): QueryPrePostagem
    {
    ...
    public function setReciboSolicitacaoAssincrona(?string $reciboSolicitacaoAssincrona): QueryPrePostagem
    {
    ...
    public function setAlturaPreAfericao(?string $alturaPreAfericao): QueryPrePostagem
    {
    ...
    public function setLarguraPreAfericao(?string $larguraPreAfericao): QueryPrePostagem
    {
    ...
    public function setComprimentoPreAfericao(?string $comprimentoPreAfericao): QueryPrePostagem
    {
    ...
    public function setDiametroPreAfericao(?string $diametroPreAfericao): QueryPrePostagem
    {
    ...
    public function setPesoPreAfericao(?string $pesoPreAfericao): QueryPrePostagem
    {
    ...
    public function setMcuUnidadePreAfericao(?string $mcuUnidadePreAfericao): QueryPrePostagem
    {
    ...
    public function setIdBalancaCubagem(?string $idBalancaCubagem): QueryPrePostagem
    {
    ...
    public function setCepDestinoPreAfericao(?string $cepDestinoPreAfericao): QueryPrePostagem
    {
    ...
    public function setEhObjetoDgr(?string $ehObjetoDgr): QueryPrePostagem
    {
    ...
    public function setTipoObjeto(?string $tipoObjeto): QueryPrePostagem
    {
    ...
    public function setErroAssincrono(?string $erroAssincrono): QueryPrePostagem
    {
    ...
    public function setCodigoEstampa2D(?string $codigoEstampa2D): QueryPrePostagem
    {
     ...
     * @return QueryPrePostagem
     */
    public function setHistoricoStatus(?array $historicoStatus): QueryPrePostagem
    {
     ...
     * @return QueryPrePostagem
     */
    public function addHistoricoStatus($historicoStatus): QueryPrePostagem
    {
    ...
    public function setIndicadorMalote(?string $indicadorMalote): QueryPrePostagem
    {
    ...
    public function setCodigoGrafica(?int $codigoGrafica): QueryPrePostagem
    {
    ...
    public function setCodigoRemetente(?string $codigoRemetente): QueryPrePostagem
    {
    ...
    public function setCodigoDestinatario(?string $codigoDestinatario): QueryPrePostagem
    {
     ...
     * @return $this
     */
    public function setMalotePrePostagem($malotePrePostagem): QueryPrePostagem
    {
     ...
     * @return QueryPrePostagem
     */
    public function setListaMalotes(?array $listaMalotes): QueryPrePostagem
    {
     ...
     * @return QueryPrePostagem
     */
    public function addMalote($malote): QueryPrePostagem
    {
